...
call <sid>set_highlight("htmlLink", "NONE", s:cyan, "underline")
call <sid>set_highlight("htmlTag", "NONE", s:gray2, "NONE")
call <sid>set_highlight("htmlTitle", "NONE", s:white, "NONE")
